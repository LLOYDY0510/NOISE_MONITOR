...
<head>
  ...
  <link rel="stylesheet" href="/NOISE_MONITOR/assets/monitoring-staff.css"/>
  <script>window.__LQ_SESSION__ = <?= json_encode($user) ?>;</script>
  <style>
    /* ============================================================
   LibraryQuiet – monitoring-staff.css (purple staff theme)
   ============================================================ */
/* ============================================================
...
.sb-av, .sb-av-lg, .tb-av {
  background: linear-gradient(135deg,#7c3aed,#8b5cf6) !important;
}
.sb-urole { color: #a78bfa !important; }
.nav-item.active {
  background: linear-gradient(90deg,rgba(124,58,237,.9),rgba(139,92,246,.8)) !important;
  color: #fff !important;
...
.nb { background: #7c3aed !important; }
.ma-btn {
  background: #faf5ff !important;
  border-color: #c4b5fd !important;
  color: #7c3aed !important;
}
.ma-btn:hover { background: #ede9fe !important; }
.view-only-notice {
  display: flex;
...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="view-only-notice">
        ...
        <div><strong>View Only</strong> — You can monitor live noise levels and sensor readings.
        To resolve alerts or manage zones, contact your <strong>Library Manager</strong> or <strong>Administrator</strong>.</div>
      </div>
      ...
      <div class="overall-card">
        <div class="ov-left">
          ...
          <div class="mgr-actions">
            <a class="ma-btn" href="/NOISE_MONITOR/dashboards/staff-alerts.php">⚑ View Alerts</a>
            <a class="ma-btn" href="/NOISE_MONITOR/dashboards/staff.php">⊞ Dashboard</a>
          </div>
        </div>
        <div class="ov-right">
      ...
      <div class="section-label">Zone Readings <span class="sl-note">Live view — read only</span></div>
  ...
  <script src="/NOISE_MONITOR/monitoring-staff.js"></script>
</body>
</html>