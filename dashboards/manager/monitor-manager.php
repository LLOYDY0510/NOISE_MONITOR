...
<head>
  ...
  <style>
/* ============================================================
   LibraryQuiet – monitoring-manager (combined)
   ============================================================ */
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{
  --blue:#1d4ed8;--teal:#0d9488;--green:#10b981;--yellow:#f59e0b;--red:#ef4444;
...
/* ── STAFF OVERRIDES ── */
.sb-av.staff,.sb-av-lg.staff,.tb-av.staff{background:linear-gradient(135deg,#7c3aed,#8b5cf6)!important}
...
.nav-locked{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;color:#475569;font-size:13px;font-weight:600;font-family:'Plus Jakarta Sans',sans-serif;user-select:none}
...
<body>
  ...
  <aside id="sidebar">
    ...
    <div class="sb-user">
      ...
      <div class="sb-user-chip">
        <div class="sb-av" id="sb-av"><?= $initial ?></div>
        <div>
          <div class="sb-uname" id="sb-uname"><?= htmlspecialchars($user['name']) ?></div>
          <div class="sb-urole" id="sb-urole">📋 Library Manager</div>
        </div>
      </div>
    </div>
    <nav id="sidebar-nav">
    ...
    <div class="sb-bottom">
      <div class="sb-av-lg" id="sb-av-lg"><?= $initial ?></div>
      <div class="sb-binfo">
        <div class="sb-bname" id="sb-bname"><?= htmlspecialchars($user['name']) ?></div>
        <div class="sb-brole" id="sb-brole">Library Manager</div>
      </div>
  ...
  <div id="main">
    <header id="topbar">
      ...
      <div class="tb-right">
        ...
        <div class="tb-av" id="tb-av"><?= $initial ?></div>
      </div>
    </header>
      ...
      <div class="card" style="margin-top:16px;">
        ...
        <div class="tbl-wrap">
          <table>
            <thead>
              <tr>
                <th>Sensor ID</th><th>Zone</th><th>Floor</th>
                <th>Current Reading</th><th>Status</th><th>Battery</th><th>Last Ping</th>
              </tr>
            </thead>
  ...
  <script>
  // ============================================================
  //  AppData — inline (was app-data.js)
  // ============================================================
  const AppData = (() => {
    ...
    return {
      ...
      loadZones, getZones, getZone, setSensorLevel, clearSensorOverride, loadSensorOverrides, getSensorOverrides,
  ...
  function buildSidebar() {
    ...
    const dashLink   = isStaff
      ? 'dashboard-staff.html'
      : '/NOISE_MONITOR/dashboards/manager/dashboard-manager.php';
  ...
  function renderOverall() {
    ...
    setText('sensor-online', zones.length + '/' + zones.length);
  }
