...
<head>
  ...
  <style>
    /* ============================================================
       LibraryQuiet – monitoring-admin.css (inlined)
    ============================================================ */
...
<body>
      ...
      <div class="card" style="margin-top:16px;">
        ...
        <div class="tbl-wrap">
          <table>
            <thead>
              <tr>
                <th>Sensor ID</th><th>Zone</th><th>Floor</th><th>Current Reading</th>
                <th>Status</th><th>Battery</th><th>Last Ping</th><th>Action</th>
              </tr>
            </thead>
  ...
  <div class="modal" id="silence-modal">
    ...
    <div class="modal-body" style="text-align:center;padding:28px 24px;">
      ...
      <p style="font-size:14px;color:#64748b;line-height:1.6;">
        This will resolve all <strong id="silence-count">0</strong> active alerts. Are you sure?
      </p>
    </div>
  ...
  function renderSensorTable() {
    ...
    setText('sensor-online', total + '/' + total);
