...
<body>
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="welcome-banner">
        <div class="wb-left">
          <div class="wb-title">Welcome back, <?= htmlspecialchars($user['name']) ?>! 👑</div>
          <div class="wb-sub">Full administrative access — view system overview, manage users and zones.</div>
        </div>
        <div class="wb-right">
          <a class="wb-btn" href="/NOISE_MONITOR/dashboards/admin/users.php">Manage Users</a>
          <a class="wb-btn wb-btn-outline" href="/NOISE_MONITOR/dashboards/admin/alerts-admin.php">View Alerts</a>
        </div>
      </div>
      ...
      <div class="sensor-view-panel">
        <div class="svp-header">
          <div class="svp-title">📡 Sensor Status <span class="svp-badge">👁 View Only</span></div>
          <a class="svp-mgr-link" href="/NOISE_MONITOR/dashboards/manager/dashboard-manager.php">⚙ Go to Manager → Edit Sensors</a>
        </div>
        <div class="svp-sub">Live readings from all zone sensors. Only the <strong>Library Manager</strong> can set sensor values.</div>
  ...
  <script src="/NOISE_MONITOR/dashboard-admin.js"></script>
