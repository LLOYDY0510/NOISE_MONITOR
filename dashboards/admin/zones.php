...
<body>
  ...
  <div id="main">
    <header id="topbar">
      ...
      <div class="tb-right">
        <div class="role-badge admin-badge" id="role-badge">👑 View Only</div>
    ...
    <div id="content">
      ...
      <!-- READONLY NOTICE -->
      <div style="background:#fef9c3;border:1.5px solid #fde047;border-radius:12px;padding:14px 20px;margin-bottom:20px;display:flex;align-items:center;gap:12px;">
        <span style="font-size:20px;">🔒</span>
        <div>
          <div style="font-weight:700;font-size:13px;color:#713f12;">View Only Mode</div>
          <div style="font-size:12px;color:#92400e;">Zone Management is controlled by the <strong>Library Manager</strong>. You can view zone details but cannot add, edit, or delete zones.</div>
        </div>
        <a href="/NOISE_MONITOR/dashboards/manager/zones.php" style="margin-left:auto;padding:8px 16px;background:#0d9488;color:#fff;border-radius:8px;font-size:12px;font-weight:700;text-decoration:none;white-space:nowrap;">Go to Manager →</a>
      </div>
  ...
  <script src="/NOISE_MONITOR/zones.js"></script>
</body>
</html>